...
program_unit: declaration | statement | block_statement;
...
if_statement: IF LPAREN exp RPAREN block_statement optional_else
        ;

while_statement: WHILE LPAREN exp RPAREN block_statement
               ;
...
optional_else: ELSE IF LPAREN exp RPAREN block_statement optional_else
